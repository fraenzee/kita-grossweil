    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          secondary: '#4a4e69', // Text, Footer #84a59d oder #6EC4DB oder #457B9D oder #0081A7 oder #FED9B7 oder #92ABD1
          ...
          soft: '#a8dadc',      // Karten #f5cac3 oder #f7ede2 oder #a8dadc oder #00AFB9 oder #f7cac9
